 ...
 * ChrisTitusTech functional approach - simplified for your profile
 */
...
export default {
  ...
  // 🌐 Social Links (ChrisTitusTech style)
  social: {
  ...
  content: {
    ...
    maxLanguages: 8,          // Languages to show in tech stack
    maxPullRequests: 5,       // Recent pull requests 
    maxStarred: 5,            // Recently starred repositories
  },
...
/*
 * 🎯 ChrisTitusTech Style Features (simplified for your use):
 * 
 ...
 * ✅ Social Links (ChrisTitusTech icon style)
 * ✅ GitHub Stats (comprehensive metrics)
 * 
 * 💡 Quick Setup:
 * 1. Username is already set to 'dacrab'
 * 2. Social links are configured for your accounts  
 * 3. Run: npm run generate
 * 
 * 🚀 Clean, functional profile like ChrisTitusTech's!
 */